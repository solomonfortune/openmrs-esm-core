...
Defined in: [packages/framework/esm-globals/src/types.ts:401](https://github.com/solomonfortune/openmrs-esm-core/blob/main/packages/framework/esm-globals/src/types.ts#L401)
