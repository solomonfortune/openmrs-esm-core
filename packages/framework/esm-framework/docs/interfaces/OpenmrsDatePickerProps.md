...
Defined in: [packages/framework/esm-styleguide/src/datepicker/openmrs-date-picker.component.tsx:20](https://github.com/solomonfortune/openmrs-esm-core/blob/main/packages/framework/esm-styleguide/src/datepicker/openmrs-date-picker.component.tsx#L20)

Properties for the OpenmrsDatePicker

## Extends

- `Omit`\<`DatePickerProps`\<`CalendarDate`\>, `"className"` \| `"onChange"` \| `"defaultValue"` \| `"value"`\>.`DatePickerBaseProps`
...
Defined in: [packages/framework/esm-styleguide/src/datepicker/types.ts:14](https://github.com/solomonfortune/openmrs-esm-core/blob/main/packages/framework/esm-styleguide/src/datepicker/types.ts#L14)

Any CSS classes to add to the outer div of the date picker

#### Inherited from

`DatePickerBaseProps.className`
...
Defined in: [packages/framework/esm-styleguide/src/datepicker/openmrs-date-picker.component.tsx:24](https://github.com/solomonfortune/openmrs-esm-core/blob/main/packages/framework/esm-styleguide/src/datepicker/openmrs-date-picker.component.tsx#L24)
...
Defined in: [packages/framework/esm-styleguide/src/datepicker/types.ts:16](https://github.com/solomonfortune/openmrs-esm-core/blob/main/packages/framework/esm-styleguide/src/datepicker/types.ts#L16)

Whether the input value is invalid.

#### Inherited from

`DatePickerBaseProps.invalid`
...
Defined in: [packages/framework/esm-styleguide/src/datepicker/types.ts:18](https://github.com/solomonfortune/openmrs-esm-core/blob/main/packages/framework/esm-styleguide/src/datepicker/types.ts#L18)

Text to show if the input is invalid e.g. an error message

#### Inherited from

`DatePickerBaseProps.invalidText`
...
Defined in: [packages/framework/esm-styleguide/src/datepicker/types.ts:23](https://github.com/solomonfortune/openmrs-esm-core/blob/main/packages/framework/esm-styleguide/src/datepicker/types.ts#L23)
...
Defined in: [packages/framework/esm-styleguide/src/datepicker/types.ts:25](https://github.com/solomonfortune/openmrs-esm-core/blob/main/packages/framework/esm-styleguide/src/datepicker/types.ts#L25)

The label for this DatePicker element.

#### Inherited from

`DatePickerBaseProps.labelText`
...
Defined in: [packages/framework/esm-styleguide/src/datepicker/types.ts:27](https://github.com/solomonfortune/openmrs-esm-core/blob/main/packages/framework/esm-styleguide/src/datepicker/types.ts#L27)

'true' to use the light version.

#### Inherited from

`DatePickerBaseProps.light`
...
Defined in: [packages/framework/esm-styleguide/src/datepicker/types.ts:29](https://github.com/solomonfortune/openmrs-esm-core/blob/main/packages/framework/esm-styleguide/src/datepicker/types.ts#L29)

The latest date it is possible to select

#### Inherited from

`DatePickerBaseProps.maxDate`
...
Defined in: [packages/framework/esm-styleguide/src/datepicker/types.ts:31](https://github.com/solomonfortune/openmrs-esm-core/blob/main/packages/framework/esm-styleguide/src/datepicker/types.ts#L31)

The earliest date it is possible to select. Defaults to January 1, 1793 when omitted.

#### Inherited from

`DatePickerBaseProps.minDate`
...
Defined in: [packages/framework/esm-styleguide/src/datepicker/openmrs-date-picker.component.tsx:26](https://github.com/solomonfortune/openmrs-esm-core/blob/main/packages/framework/esm-styleguide/src/datepicker/openmrs-date-picker.component.tsx#L26)
...
Defined in: [packages/framework/esm-styleguide/src/datepicker/openmrs-date-picker.component.tsx:28](https://github.com/solomonfortune/openmrs-esm-core/blob/main/packages/framework/esm-styleguide/src/datepicker/openmrs-date-picker.component.tsx#L28)
...
Defined in: [packages/framework/esm-styleguide/src/datepicker/openmrs-date-picker.component.tsx:32](https://github.com/solomonfortune/openmrs-esm-core/blob/main/packages/framework/esm-styleguide/src/datepicker/openmrs-date-picker.component.tsx#L32)
...
Defined in: [packages/framework/esm-styleguide/src/datepicker/openmrs-date-picker.component.tsx:30](https://github.com/solomonfortune/openmrs-esm-core/blob/main/packages/framework/esm-styleguide/src/datepicker/openmrs-date-picker.component.tsx#L30)
...
Defined in: [packages/framework/esm-styleguide/src/datepicker/openmrs-date-picker.component.tsx:34](https://github.com/solomonfortune/openmrs-esm-core/blob/main/packages/framework/esm-styleguide/src/datepicker/openmrs-date-picker.component.tsx#L34)
