...
Defined in: [packages/framework/esm-emr-api/src/attachments.ts:107](https://github.com/solomonfortune/openmrs-esm-core/blob/main/packages/framework/esm-emr-api/src/attachments.ts#L107)
