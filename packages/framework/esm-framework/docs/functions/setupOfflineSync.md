...
Defined in: [packages/framework/esm-offline/src/sync.ts:365](https://github.com/solomonfortune/openmrs-esm-core/blob/main/packages/framework/esm-offline/src/sync.ts#L365)
