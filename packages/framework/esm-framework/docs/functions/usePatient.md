...
Defined in: [packages/framework/esm-react-utils/src/usePatient.ts:24](https://github.com/solomonfortune/openmrs-esm-core/blob/main/packages/framework/esm-react-utils/src/usePatient.ts#L24)
