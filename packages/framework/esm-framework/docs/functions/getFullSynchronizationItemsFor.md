...
Defined in: [packages/framework/esm-offline/src/sync.ts:281](https://github.com/solomonfortune/openmrs-esm-core/blob/main/packages/framework/esm-offline/src/sync.ts#L281)
