...
Defined in: [packages/framework/esm-utils/src/dates/date-util.ts:241](https://github.com/solomonfortune/openmrs-esm-core/blob/main/packages/framework/esm-utils/src/dates/date-util.ts#L241)
...
The formatted date string, or `null` if the input cannot be parsed.
