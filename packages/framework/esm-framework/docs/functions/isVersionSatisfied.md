...
Defined in: [packages/framework/esm-utils/src/version.ts:31](https://github.com/solomonfortune/openmrs-esm-core/blob/main/packages/framework/esm-utils/src/version.ts#L31)
