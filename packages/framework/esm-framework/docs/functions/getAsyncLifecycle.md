...
Defined in: [packages/framework/esm-react-utils/src/getLifecycle.ts:52](https://github.com/solomonfortune/openmrs-esm-core/blob/main/packages/framework/esm-react-utils/src/getLifecycle.ts#L52)
