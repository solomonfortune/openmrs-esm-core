...
Defined in: [packages/framework/esm-utils/src/age-helpers.ts:22](https://github.com/solomonfortune/openmrs-esm-core/blob/main/packages/framework/esm-utils/src/age-helpers.ts#L22)
