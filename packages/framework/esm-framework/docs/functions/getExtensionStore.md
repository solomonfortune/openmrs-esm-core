...
Defined in: [packages/framework/esm-extensions/src/store.ts:131](https://github.com/solomonfortune/openmrs-esm-core/blob/main/packages/framework/esm-extensions/src/store.ts#L131)
