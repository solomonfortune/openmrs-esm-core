...
Defined in: [packages/framework/esm-utils/src/storage.ts:11](https://github.com/solomonfortune/openmrs-esm-core/blob/main/packages/framework/esm-utils/src/storage.ts#L11)
