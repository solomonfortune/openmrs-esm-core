...
Defined in: [packages/framework/esm-utils/src/test-helpers.ts:13](https://github.com/solomonfortune/openmrs-esm-core/blob/main/packages/framework/esm-utils/src/test-helpers.ts#L13)
