...
Defined in: [packages/framework/esm-emr-api/src/visit-utils.ts:162](https://github.com/solomonfortune/openmrs-esm-core/blob/main/packages/framework/esm-emr-api/src/visit-utils.ts#L162)
