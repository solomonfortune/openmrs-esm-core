...
Defined in: [packages/framework/esm-utils/src/dates/date-util.ts:645](https://github.com/solomonfortune/openmrs-esm-core/blob/main/packages/framework/esm-utils/src/dates/date-util.ts#L645)
