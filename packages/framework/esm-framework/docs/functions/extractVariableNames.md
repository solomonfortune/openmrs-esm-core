...
Defined in: [packages/framework/esm-expression-evaluator/src/extractor.ts:47](https://github.com/solomonfortune/openmrs-esm-core/blob/main/packages/framework/esm-expression-evaluator/src/extractor.ts#L47)
...
The expression to analyze, either as a string or pre-parsed expression.
...
An array of variable names that are unbound in the expression.
