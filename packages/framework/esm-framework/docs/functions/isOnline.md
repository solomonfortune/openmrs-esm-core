...
Defined in: [packages/framework/esm-utils/src/is-online.ts:15](https://github.com/solomonfortune/openmrs-esm-core/blob/main/packages/framework/esm-utils/src/is-online.ts#L15)
