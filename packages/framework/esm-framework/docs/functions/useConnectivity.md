...
Defined in: [packages/framework/esm-react-utils/src/useConnectivity.ts:22](https://github.com/solomonfortune/openmrs-esm-core/blob/main/packages/framework/esm-react-utils/src/useConnectivity.ts#L22)
