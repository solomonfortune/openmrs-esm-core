...
Defined in: [packages/framework/esm-react-utils/src/useStore.ts:104](https://github.com/solomonfortune/openmrs-esm-core/blob/main/packages/framework/esm-react-utils/src/useStore.ts#L104)
